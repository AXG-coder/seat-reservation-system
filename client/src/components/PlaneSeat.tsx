    ...
    <div className="flex flex-col gap-12 place-items-center justify-center duration-700 ease-in-out m-7 bg-Secondary p-8 rounded-2xl">
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div
          ...
          className="w-11 h-6  peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 peer-focus:main rounded-full peer bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all 
          border-gray-600 peer-checked:bg-blue-600"
        ></div>
        <span className="ml-3 text-sm font-medium  text-white">Show seat</span>
      </label>
